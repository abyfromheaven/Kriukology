...
const kamus = {
  ...
  id: {
    ...
    paymentTotalLabel: 'Total Pembayaran',
    paymentMethodsHeading: 'Pilihan Metode Pembayaran',
  ...
  en: {
    ...
    paymentTotalLabel: 'Total Payment',
    paymentMethodsHeading: 'Choose Payment Method',
